...
function HomePage({navigation, route}) {
    ...
    const a= route.params.user.password
    const b= route.params.user.user_name
  return (<>
...
>
    ...
    <Text style={styles.Text  } >Şifre:  {a}</Text>
    <Text style={styles.Text  } >Ad:   {b}</Text>


<View >

    <TouchableOpacity onPress={()=>{navigation.navigate('SecondPage')}}>
         <Text style={styles.Button}>2.sayfa</Text> 
